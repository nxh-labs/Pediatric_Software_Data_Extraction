...
const antibacterials: Next_Medicine[] = [
  {
...
const antifungals: Next_Medicine[] = [
  {
...
const cardiacfailure: Next_Medicine[] = [
  {
...
const alternatives: Next_Medicine[] = [
  {
